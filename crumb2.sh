...
curl -u "jenkins:1234" -H "$crumb" -X POST http://localhost:8080/job/backup-db-to-aws/buildWithParameters?DB_HOST=db_host&DB_NAME=testdb&BUCKET_NAME=jenkins-abraham
